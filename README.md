...
---
## ⚡ How to Install
1. Navigate to the [**Releases**](https://github.com/henrymendis/Floating-Dashboard-App/releases) tab on the right side of this page.
...
2. Paste your secret `.ics` or `iCal` URLs into the list. For example:
   ...
   ```
3. Save the file. The dashboard will now automatically sync your upcoming calendar events straight to the scrolling Marquee!
### 🎵 How to Add Custom Chimes & Ambient Music
Want a custom sound for your hourly alarms?
1. Open the newly generated **`audio_cache`** folder.
2. Drop any personal `.mp3` audio files directly into this folder.
3. The dashboard will automatically detect them and play your custom audio files for the hourly and quarterly chimes!
---
## 💳 Licensing & Free Trial
Floating Dashboard comes with a fully automated, cloud-synced **30-Day Free Trial**. 
Once your trial expires, you can seamlessly purchase a premium license key directly through the app to unlock lifetime access.
---
<div align="center">
  <i>Built to revolutionize how you manage your day. Download now and take back your time!</i>
</div>
